...
export default function ViajesPage() {
  ...
  const cargar = useCallback(
    (pg, f) => {
      ...
      adminApi
        ...
        .catch(() => toast.error('Error al cargar viajes'))
  ...
  return (
    <div>
      <PageHeader
        title="Viajes"
        subtitle="Todos los viajes de la plataforma con filtros"
      />
      ...
      {loading ? (
        ...
        <>
          <Table
            head={['ID', 'Cliente', 'Conductor', 'Precio', 'Fecha', 'Estado']}
            empty="No hay viajes que coincidan con los filtros"
          >
